...
# Indexes
#
#  index_subjects_on_account_id            (account_id)
#  index_subjects_on_title_and_account_id  (title,account_id) UNIQUE
#
...
class Subject < ApplicationRecord
  ...
  def update_associated_models
    ...
    Subjects::UpdateJob.perform_later(title, title_previously_was, account_id)
  end
end
