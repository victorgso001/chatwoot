...
const GO_TO_COMMANDS = [
  ...
  {
    id: 'open_subject_reports',
    section: 'COMMAND_BAR.SECTIONS.REPORTS',
    title: 'COMMAND_BAR.COMMANDS.GO_TO_SUBJECT_REPORTS',
    featureFlag: FEATURE_FLAGS.REPORTS,
    icon: ICON_SUBJECT_REPORTS,
    path: accountId => `accounts/${accountId}/reports/subject`,
    role: ['administrator'],
  },
  {
  ...
  {
    id: 'open_subject_settings',
    title: 'COMMAND_BAR.COMMANDS.GO_TO_SETTINGS_SUBJECTS',
    featureFlag: FEATURE_FLAGS.SUBJECTS,
    section: 'COMMAND_BAR.SECTIONS.SETTINGS',
    icon: ICON_SUBJECTS,
    path: accountId => `accounts/${accountId}/settings/subjects/list`,
    role: ['administrator'],
  },
  {
